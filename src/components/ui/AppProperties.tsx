...
export enum Invokes {
  ...
  AnalyzeForImport = 'analyze_for_import',
  ...
  LoadManualOrder = 'load_manual_order',
  MoveFiles = 'move_files',
  SaveManualOrder = 'save_manual_order',
  ...
  ScanDetectScanner = 'scan_detect_scanner',
  ScanPreview = 'scan_preview',
  ScanRerenderPreview = 'scan_rerender_preview',
  ...
  TetherConnectCamera = 'tether_connect_camera',
