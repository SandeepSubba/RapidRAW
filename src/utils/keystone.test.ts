...
assert(v.transformScale > 100 && v.transformScale <= 150, 'should zoom in (scale>100) to crop black');
...
// 5) Strong keystone zooms in harder (capped at the 150% slider max).
...
assert(strong.transformScale > 100 && strong.transformScale <= 150, 'strong keystone should zoom in more');
