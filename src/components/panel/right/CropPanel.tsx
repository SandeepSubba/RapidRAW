...
export default function CropPanel() {
  ...
  // zoom — loaded from a sidecar, undo/redo, or the guided tool. The perspective
  // sliders already pair Scale in their onChange; this covers every other path. Only
                            ...
                            <Slider
                              ...
                              onChange={(e) => {
                                ...
                                setAdjustments((prev) => ({
                                  ...prev,
                                  transformVertical: v,
                                  transformScale: fitScaleForParams(v, prev.transformHorizontal || 0),
                                }));
                              }}
                            />
                            <Slider
                              ...
                              onChange={(e) => {
                                ...
                                setAdjustments((prev) => ({
                                  ...prev,
                                  transformHorizontal: h,
                                  transformScale: fitScaleForParams(prev.transformVertical || 0, h),
                                }));
                              }}
                            />
                          </div>
